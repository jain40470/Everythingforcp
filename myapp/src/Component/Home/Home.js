        ...
        <div className="text-blue-800 flex-col justify-center items-center mt-4">
            ...
            <div className="flex flex-col gap-6 mt-10">
                ...
                <div className="flex flex-wrap text-lg gap-20 w-full justify-center items-center">
                    <HomeCard name="CP-Algorithm" link="https://cp-algorithms.com/" photo={cpalgo} />
                    <HomeCard name="CSES" link="https://cses.fi/problemset/" photo={cses} />
                    <HomeCard name="Priyansh Aggarwal" link="https://www.youtube.com/@PriyanshAgarwal" photo={priyansh} />
                </div>
            </div>
            <div className="flex flex-col gap-6 mt-10">
                ...
                <div className="flex flex-wrap text-lg gap-20 w-full justify-center items-center">
                    <HomeCard name="Codeforces" link="https://codeforces.com/" photo={codeforces} />
                    <HomeCard name="Codechef" link="https://www.codechef.com/" photo={codechef} />
